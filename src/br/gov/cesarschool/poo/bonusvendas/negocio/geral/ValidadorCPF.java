...
public class ValidadorCPF {
	...
	public static boolean ehCpfValidado(String cpf) {
		...
		int penultimoValor = Character.getNumericValue(penultimoCaracter); // transforma o ultimo caracter da string em
																			// in

		if (valorTotal == penultimoValor) { // se valorTotal for igual ao penultimo caracter isso que dizer que o
											// primiero caso está correto
		...
		if (valorTotal == ultimoCaracter) { // se o ultimo caraceter for igual ao rsto da divisão, então está correto o
											// segundo caso de validação
